...
class Subs(models.Model):
    serie_nombre = models.CharField(max_length=255, null=True, blank=True)
    Subs = models.CharField(max_length=255)  # Usamos el nombre "Subs" tal como está en el fixture
